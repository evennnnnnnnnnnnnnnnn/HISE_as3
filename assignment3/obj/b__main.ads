...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#0f29da52#;
   ...
   u00121 : constant Version_32 := 16#de2a2a64#;
   pragma Export (C, u00121, "calculatorB");
   u00122 : constant Version_32 := 16#b118ec15#;
   pragma Export (C, u00122, "calculatorS");
   ...
   u00125 : constant Version_32 := 16#bb264ce2#;
   pragma Export (C, u00125, "ada__strings__searchB");
   u00126 : constant Version_32 := 16#73987e07#;
   pragma Export (C, u00126, "ada__strings__searchS");
   u00127 : constant Version_32 := 16#a1d6147d#;
   pragma Export (C, u00127, "system__compare_array_unsigned_8B");
   u00128 : constant Version_32 := 16#86f92099#;
   ...
   u00130 : constant Version_32 := 16#3cf6ef27#;
   ...
   u00132 : constant Version_32 := 16#9ba67c99#;
   pragma Export (C, u00132, "system__atomic_countersS");
   u00133 : constant Version_32 := 16#c9a3fcbc#;
   pragma Export (C, u00133, "system__stream_attributesB");
   u00134 : constant Version_32 := 16#414158da#;
   ...
   u00136 : constant Version_32 := 16#ce9a2a0c#;
   pragma Export (C, u00136, "system__stream_attributes__xdrS");
   u00137 : constant Version_32 := 16#ecc88e78#;
   pragma Export (C, u00137, "system__fat_fltS");
   u00138 : constant Version_32 := 16#cafa8775#;
   pragma Export (C, u00138, "system__fat_lfltS");
   u00139 : constant Version_32 := 16#b02a299f#;
   pragma Export (C, u00139, "system__fat_llfS");
   u00140 : constant Version_32 := 16#e61bb447#;
   pragma Export (C, u00140, "commandhandlerB");
   u00141 : constant Version_32 := 16#c93b59ef#;
   pragma Export (C, u00141, "commandhandlerS");
   u00142 : constant Version_32 := 16#e0fc5882#;
   pragma Export (C, u00142, "integer_operationsB");
   u00143 : constant Version_32 := 16#9ef0fb40#;
   pragma Export (C, u00143, "integer_operationsS");
   u00144 : constant Version_32 := 16#57817ae9#;
   pragma Export (C, u00144, "memorystoreB");
   u00145 : constant Version_32 := 16#a9e9553e#;
   pragma Export (C, u00145, "memorystoreS");
   u00146 : constant Version_32 := 16#f64b89a4#;
   pragma Export (C, u00146, "ada__integer_text_ioB");
   u00147 : constant Version_32 := 16#2ec7c168#;
   pragma Export (C, u00147, "ada__integer_text_ioS");
   u00148 : constant Version_32 := 16#7a00bb28#;
   pragma Export (C, u00148, "ada__text_io__generic_auxB");
   u00149 : constant Version_32 := 16#48b7189e#;
   pragma Export (C, u00149, "ada__text_io__generic_auxS");
   u00150 : constant Version_32 := 16#3720d920#;
   pragma Export (C, u00150, "system__img_biuS");
   u00151 : constant Version_32 := 16#7a7e1efe#;
   pragma Export (C, u00151, "system__img_llbS");
   u00152 : constant Version_32 := 16#15e60e4c#;
   pragma Export (C, u00152, "system__img_lliS");
   u00153 : constant Version_32 := 16#0d8feb8c#;
   pragma Export (C, u00153, "system__img_lllbS");
   u00154 : constant Version_32 := 16#7e360bb4#;
   pragma Export (C, u00154, "system__img_llliS");
   u00155 : constant Version_32 := 16#07fbf280#;
   pragma Export (C, u00155, "system__img_lllwS");
   u00156 : constant Version_32 := 16#264c6bf5#;
   pragma Export (C, u00156, "system__img_llwS");
   u00157 : constant Version_32 := 16#08fa6212#;
   pragma Export (C, u00157, "system__img_wiuS");
   u00158 : constant Version_32 := 16#ae4beccb#;
   pragma Export (C, u00158, "system__val_intS");
   u00159 : constant Version_32 := 16#a5b55d2f#;
   pragma Export (C, u00159, "system__val_unsS");
   u00160 : constant Version_32 := 16#e37e7d10#;
   pragma Export (C, u00160, "system__val_llliS");
   u00161 : constant Version_32 := 16#f82486d6#;
   ...
   u00164 : constant Version_32 := 16#0c5e1d96#;
   pragma Export (C, u00164, "pinB");
   u00165 : constant Version_32 := 16#553c8633#;
   ...
   u00172 : constant Version_32 := 16#2d5a86c4#;
   pragma Export (C, u00172, "system__concat_2S");
   u00173 : constant Version_32 := 16#2b70b149#;
   pragma Export (C, u00173, "system__concat_3B");
   u00174 : constant Version_32 := 16#248a0db1#;
   pragma Export (C, u00174, "system__concat_3S");
   u00175 : constant Version_32 := 16#aa5b56bd#;
   pragma Export (C, u00175, "commandparserB");
   u00176 : constant Version_32 := 16#9cdaaedd#;
   pragma Export (C, u00176, "commandparserS");
   u00177 : constant Version_32 := 16#0de7ae30#;
   pragma Export (C, u00177, "ada__strings__fixedB");
   u00178 : constant Version_32 := 16#64881af1#;
   ...
   u00184 : constant Version_32 := 16#76873720#;
   ...
   --  integer_operations%s
   --  integer_operations%b
   --  memorystore%s
   --  memorystore%b
   --  mycommandline%s
   --  mycommandline%b
